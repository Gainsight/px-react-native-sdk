  ...
  /******/ var __webpack_modules__ = [
    ...
    /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      function sendMessage(body) {
        var tsWindow = window;
        if (
          (0, _platformType__WEBPACK_IMPORTED_MODULE_0__.getPlatformType)() ===
          _type__WEBPACK_IMPORTED_MODULE_1__.PlatformType.ios
        ) {
          tsWindow.webkit.messageHandlers.gpxjs.postMessage(body);
        } else if (
          (0, _platformType__WEBPACK_IMPORTED_MODULE_0__.getPlatformType)() ===
          _type__WEBPACK_IMPORTED_MODULE_1__.PlatformType.android
        ) {
      ...
      function startEngine() {
        if (window !== null) {
          engineStarted = true;
          (0, _gainsightpx__WEBPACK_IMPORTED_MODULE_2__.createEvent)({
            type: _type__WEBPACK_IMPORTED_MODULE_1__.kEventType.engineState,
            params: { state: true }
          });
          setTimeout(function() {
    ...
    /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var GainsightPX = {
        ...
        initialize: function(config) {
          try {
            ...
            configuration &&
              createEvent({ type: _type__WEBPACK_IMPORTED_MODULE_3__.kEventType.initialize, params: config });
            ...
            configuration.shouldTrackPages &&
              this.screenEvent({ screenName: window.location.href, screenClass: "", properties: null });
          } catch (e) {
            callHome(e);
          }
        },
        ...
        hasGlobalContext: function(key) {
          try {
            createEvent({
              type: _type__WEBPACK_IMPORTED_MODULE_3__.kEventType.hasGlobalContextValue,
              params: { key: key }
            });
          } catch (e) {
            callHome(e);
        ...
        removeGlobalContextKeys: function(keys) {
          try {
            createEvent({
              type: _type__WEBPACK_IMPORTED_MODULE_3__.kEventType.removeGloablContextValues,
              params: { keys: keys }
            });
          } catch (e) {
            callHome(e);
        ...
        enterEditingMode: function(urlString) {
          try {
            createEvent({
              type: _type__WEBPACK_IMPORTED_MODULE_3__.kEventType.enterEditing,
      ...
      function updateConfigurations(config) {
        ...
        configuration.shouldTrackTapEvents && (0, _tapTracker__WEBPACK_IMPORTED_MODULE_2__.startTapTracker)();
        configuration.shouldTrackPages &&
          GainsightPX.screenEvent({ screenName: window.location.href, screenClass: "", properties: null });
      }
    ...
    /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        if (_gainsightpx__WEBPACK_IMPORTED_MODULE_0__.configuration.shouldTrackPages) {
          try {
            if (
              ...
              _gainsightpx__WEBPACK_IMPORTED_MODULE_0__.configuration.autoTrackHash === true
            ) {
      ...
      function handleStateChange(handlerArguments, oldHandler, ignoreStateOnlyChanges) {
        try {
          if (
            !(
              _gainsightpx__WEBPACK_IMPORTED_MODULE_0__.configuration.enabled &&
              _gainsightpx__WEBPACK_IMPORTED_MODULE_0__.configuration.shouldTrackPages
            )
          ) {
            return;
          }
      ...
      var reportScreenEvent = debounce(function() {
        _gainsightpx__WEBPACK_IMPORTED_MODULE_0__.GainsightPX.screenEvent({
    ...
    /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      function trackClicks(event) {
        try {
          ...
          (0, _gainsightpx__WEBPACK_IMPORTED_MODULE_1__.createEvent)({
            type: _type__WEBPACK_IMPORTED_MODULE_2__.kEventType.tap,
            params: tapEvent
          });
        } catch (e) {
      ...
      function getTapEventForElement(htmlElement) {
        try {
          ...
          while (element) {
            ...
            var pxElement = {
              className: (0, _editor__WEBPACK_IMPORTED_MODULE_0__.modifyClassName)(className),
              childN: childN,
              childClassN: childClassN,
              attributes: {}
            };
            if (element.id) {
            ...
            if (parent_1) {
              pxElement.attributes.superClass = (0, _editor__WEBPACK_IMPORTED_MODULE_0__.modifyClassName)(
                parent_1.nodeName.toLowerCase()
              );
            }
...
*/
      function getLayoutOffset(shouldIgnoreSafeArea) {
        ...
        if (pxLayout != null && pxLayout.frame != null) {
          ...
          if (
            !___WEBPACK_IMPORTED_MODULE_0__.ignoreSafeAreaOffset &&
            !shouldIgnoreSafeArea &&
            pxLayout.safeArea != null
          ) {
            if (pxLayout.frame.x < pxLayout.safeArea.left) {
              location.x = pxLayout.safeArea.left;
            }
            if (pxLayout.frame.y < pxLayout.safeArea.top) {
              //when y=0 and top is 47(or any number), which should be added if ignoreSafeAreaOffset is false
      ...
      function domForRoot(root) {
        try {
          ...
          var offset = getLayoutOffset(
            (0, _platformType__WEBPACK_IMPORTED_MODULE_2__.getPlatformType)() ==
              _type__WEBPACK_IMPORTED_MODULE_4__.PlatformType.android
          );
          pxRect.y += offset.y;
          pxRect.x += offset.x;
          ...
          if (root.childElementCount > 0) {
            ...
            domElement.children = arr
              .map(function(element) {
                return domForRoot(element);
              })
      ...
      var GPXSDKTOJS = {
        ...
        createDOMStructure: function() {
          try {
            ...
            (0, _gainsightpx__WEBPACK_IMPORTED_MODULE_1__.createEvent)({
              type: _type__WEBPACK_IMPORTED_MODULE_3__.kEventType.dom,
              params: dom
            });
          } catch (e) {
            (0, _gainsightpx__WEBPACK_IMPORTED_MODULE_1__.callHome)(e);
        ...
        getElementAtPosition: function(location) {
          ...
          try {
            ...
            (0, _gainsightpx__WEBPACK_IMPORTED_MODULE_1__.createEvent)({
              type: _type__WEBPACK_IMPORTED_MODULE_3__.kEventType.elementAtPosition,
              params: element
            });
          } catch (e) {
            (0, _gainsightpx__WEBPACK_IMPORTED_MODULE_1__.callHome)(e);
        ...
        getElementPosition: function(tree) {
          ...
          try {
            ...
            (0, _gainsightpx__WEBPACK_IMPORTED_MODULE_1__.createEvent)({
              type: _type__WEBPACK_IMPORTED_MODULE_3__.kEventType.elementPosition,
              params: position
            });
          } catch (e) {
            (0, _gainsightpx__WEBPACK_IMPORTED_MODULE_1__.callHome)(e);
